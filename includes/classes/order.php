...
*/
  ...
  function create($zf_ot_modules, $zf_mode = 2) {
	...
	$custom_order = new CustomOrderID(); // Initiate Custom Order ID Class
	$oid = $custom_order->generateOrderID();
    $sql_data_array = array('orders_id' => $oid, // added order id to data array 
					...
					} // End of custom order code change
						else { // execute original zen cart code
